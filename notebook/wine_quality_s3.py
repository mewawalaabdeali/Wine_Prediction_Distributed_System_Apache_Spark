...
spark = SparkSession.builder \
    .appName("Wine_Quality_Prediction_S3_Setup") \
    .config("spark.executor.memory", "2g") \
    .config("spark.executor.cores", "2") \
    .getOrCreate()

# Step 2: Load and Clean Data
# Use S3 path for file access
data = spark.read.csv("s3://winepredictionabdeali/TrainingDataset.csv", header=True, inferSchema=True, sep=";")
