...
if(EXISTS "C:/Projects/Wine_Prediction_Distributed_System_Apache_Spark/venv/Library/lib/cmake")
  get_filename_component(_BOOST_CMAKEDIR_ORIGINAL "C:/Projects/Wine_Prediction_Distributed_System_Apache_Spark/venv/Library/lib/cmake" REALPATH)
  if(_BOOST_CMAKEDIR STREQUAL _BOOST_CMAKEDIR_ORIGINAL)
    set(_BOOST_CMAKEDIR "C:/Projects/Wine_Prediction_Distributed_System_Apache_Spark/venv/Library/lib/cmake")
  endif()
...
foreach(dep_boost_stacktrace_windbg_cached IN LISTS _BOOST_STACKTRACE_WINDBG_CACHED_DEPS)
  ...
  find_package(boost_${dep_boost_stacktrace_windbg_cached} 1.78.0 EXACT CONFIG ${_BOOST_REQUIRED} ${_BOOST_QUIET} HINTS ${_BOOST_CMAKEDIR})
