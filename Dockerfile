...
COPY notebook/prediction_gbt_docker.py /Wine_Prediction_Distributed_System_Apache_Spark/notebook/
...
ENTRYPOINT ["spark-submit", "--master", "local[*]", "/Wine_Prediction_Distributed_System_Apache_Spark/notebook/prediction_gbt_docker.py"]
