...
COPY notebook/wine_final_docker_testing.py /Wine_Prediction_Distributed_System_Apache_Spark/notebook/
...
ENTRYPOINT ["spark-submit", "--master", "local[*]", "/Wine_Prediction_Distributed_System_Apache_Spark/notebook/wine_final_docker_testing.py"]
